...
//func Outbound(c *fiber.Ctx) error {
//	ctx := base.NewContext(c)
//
//	// Create a new user auth struct.
//	request := &models.OutboundRequest{}
//
...
//	result, err := outbound.SendWaMessageToQueue(request)
//	// Return status 200 OK.
//	return ctx.Response(result, err)
//}
//
//func OutboundBulk(c *fiber.Ctx) error {
//	ctx := base.NewContext(c)
//
//	// Create a new user auth struct.
//	request := &models.OutboundBulkRequest{}
//
//	// Checking received data from JSON body.
//	if err := ctx.BodyParser(request); err != nil {
//		// Return status 400 and error message.
...
//	}
//	outbound := usecase.NewOutboundUsecase(ctx.Session)
//	result, err := outbound.SendWaMessageToQueueBulk(request)
//	// Return status 200 OK.
//	return ctx.Response(result, err)
//}
